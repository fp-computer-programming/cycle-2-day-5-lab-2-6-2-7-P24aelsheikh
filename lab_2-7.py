...
else: print('a is between -5 and 5')
b=10
if (b % 2) ==0:
    print('b is even.')
else:
...
else: print('b is between -5 and 5')   
c=0
if (c % 2) ==0:
    print('c is even.')
else:
...
else: print('c is between -5 and 5')
d=-4
if (d % 2) ==0:
    print('d is even.')
else:
    print('d is odd')
if (d>=5):
    print('d is greater than or equal to 5')
elif (-5>=d):
    print("d is less than or equal to -5")
else: print('d is between -5 and 5')